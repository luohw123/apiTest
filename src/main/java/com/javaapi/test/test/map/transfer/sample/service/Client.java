package com.javaapi.test.test.map.transfer.sample.service;
...
import com.javaapi.test.test.map.transfer.sample.po.Account;
import com.javaapi.test.test.map.transfer.sample.po.CashBook;
import com.javaapi.test.test.map.transfer.sample.po.CashBookTrade;
