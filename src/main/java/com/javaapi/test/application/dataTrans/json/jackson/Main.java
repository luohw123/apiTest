package com.javaapi.test.application.dataTrans.json.jackson;
...
public class Main {
	public static void main(String[] args) throws Exception {
		...
		// globally
		// User user = mapper.readValue(new File("target/classes/user.json"),
		// User.class);
		...
		// // can either use mapper.readTree(source), or
