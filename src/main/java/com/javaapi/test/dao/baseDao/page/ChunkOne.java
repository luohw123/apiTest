...
abstract class ChunkOne<T> implements Slice<T>, Serializable {
    ...
    /**
     * Creates a new {@link ChunkOne} with the given content and the given governing {@link Pageable}.
     *
     * @param content must not be {@literal null}.
     * @param pageable can be {@literal null}.
     */
    public ChunkOne(List<T> content, Pageable pageable) {
    ...
    /**
     * Applies the given {@link Converter} to the content of the {@link ChunkOne}.
     *
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ChunkOne<?>)) {
            return false;
        }

        ChunkOne<?> that = (ChunkOne<?>) obj;
