package com.javaapi.test.testUtil.IO.FileIO;
...
public class NIOFileVideo {
	...
	private static final String imagePath = "/Users/user/program/shell/videoread/Firefox-latest.dmg";
	...
	public void testReadWrite() {
		...
		try {
			...
			os = new FileOutputStream(new File(imagePath + random));
