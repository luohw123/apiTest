package com.javaapi.test.testUtil.IO.nio;
...
public class TestServerOther {
	...
	public TestServerOther() throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		TestServerOther server = new TestServerOther();
	...
	public void listen() throws IOException { // 服务器开始监听端口，提供服务
		...
		try {
			while (true) {// 与通常的程序不同，这里使用channel.accpet()接受客户端连接请求，而不是在socket对象上调用accept(),
