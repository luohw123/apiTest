...
public class DbInUtil4 {
    ...
    public void test() throws IOException {
        ...
        String s = "/Users/user/program/shellTmp/过审的只有letv没有youku_sid_letvVid_size.txt";
        ...
        System.out.println("所有result的总数为:" + (result1.size()+result2.size()+result3.size()+result4.size()+result5.size()));

        FileUtils.writeLines(new File("/Users/user/program/shellTmp/过审的只有letv没有youku_sid_letvVid_area1.txt"),result1);
        FileUtils.writeLines(new File("/Users/user/program/shellTmp/过审的只有letv没有youku_sid_letvVid_area2.txt"),result2);
        FileUtils.writeLines(new File("/Users/user/program/shellTmp/过审的只有letv没有youku_sid_letvVid_area3.txt"),result3);
        FileUtils.writeLines(new File("/Users/user/program/shellTmp/过审的只有letv没有youku_sid_letvVid_area4.txt"),result4);
        FileUtils.writeLines(new File("/Users/user/program/shellTmp/过审的只有letv没有youku_sid_letvVid_area5.txt"),result5);
