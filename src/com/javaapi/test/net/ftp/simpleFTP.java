package com.javaapi.test.net.ftp;
...
public class simpleFTP {
	...
	public synchronized boolean upload(InputStream inputStream, String fileName)
			throws Exception {
		...
		if (closing > 0) {
			...
			try {
				...
				port = Integer.parseInt(tokenzier.nextToken()) * 256
						+ Integer.parseInt(tokenzier.nextToken());
				;
			} catch (Exception e) {
